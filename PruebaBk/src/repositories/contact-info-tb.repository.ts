...
> {
  ...
  constructor(
    @inject('datasources.bdmysql') dataSource: BdmysqlDataSource, @repository.getter('CountryTbRepository') protected countryTbRepositoryGetter: Getter<CountryTbRepository>, @repository.getter('AppUserTbRepository') protected appUserTbRepositoryGetter: Getter<AppUserTbRepository>,
  ) {
